...

{
  ...
  // Output file name
  TString outFile ="./data/attpcsim_3.root";
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
    ...
    ExE.push_back(0.0);//In MeV
     ...
     ExE.push_back(0.0);//In MeV
        ...
        ATTPC3Body* ThreeBody = new ATTPC3Body("ThreeBody",&Zp,&Ap,&Qp,mult,&Pxp,&Pyp,&Pzp,&Mass,&ExE,ResEner, ThetaMinCMS,ThetaMaxCMS);
        primGen->AddGenerator(ThreeBody);
