...
Int_t ATTPC3Body::fgNIon = 0;


ATTPC3Body::ATTPC3Body()
  : fMult(0),
    fPx(0.), fPy(0.), fPz(0.),
    fVx(0.), fVy(0.), fVz(0.),
    fIon(0),  fQ(0)
...
// -----   Default constructor   ------------------------------------------
ATTPC3Body::ATTPC3Body(const char* name,std::vector<Int_t> *z,std::vector<Int_t> *a,std::vector<Int_t> *q, Int_t mult, std::vector<Double_t> *px,
...
Bool_t ATTPC3Body::ReadEvent(FairPrimaryGenerator* primGen) {
   ...
   std::cout<<" -I- ATTPC3Body : Random CMS Theta angle in degrees : "<<thetacmsInput<<std::endl;
   ...
   std::cout<<" -I- ATTPC3Body Residual energy  : "<<gATVP->GetEnergy()<<std::endl;
...
// Lorentz transformations to lab -----
  ...
  Ene.push_back(TMath::Sqrt(p4_lab*p4_lab+fWm.at(3)*fWm.at(3))-fWm.at(3));
    ...
    if(!gATVP->GetValidKine()){
     std::cout << " -I- ===== ATTPC3Body - Kinematics ====== "<<std::endl;
